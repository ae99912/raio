...
function loadRegs()
{
  ...
  $.getJSON("/ae/ra/lor.php",{gok: cod}).done(function (data) {
...
function regPolygon(idreg, name)
{
  ...
  var promise_reg = new Promise(function (resolve, reject) {
    ...
    $.getJSON("/ae/ra/que.php", {q: idreg}) // {q: query, format: "json", polygon_geojson: 1, polygon_threshold: 0.001}
      .done(function (data) {
